...
const PurchaseInfoScreen = ({ navigation }) => {
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                    ...
                    <Motion.SlideUp delay={200}>
                        <GlassCard style={styles.infoCard} intensity={30}>
                            ...
                            <Text style={[styles.cardText, { color: theme.colors.textSecondary }]}>En hızlı yöntem olan Telegram canlı destek hattımız üzerinden anında coin yüklemesi yapabilir ve sorularınıza cevap bulabilirsiniz.</Text>
                            <TouchableOpacity style={[styles.actionButton, { backgroundColor: '#FBBF24' }]}>
                                <Text style={styles.actionButtonText}>@dating_support'a Yaz</Text>
                            </TouchableOpacity>
                        </GlassCard>
                    </Motion.SlideUp>
                    <Motion.SlideUp delay={300}>
                        <GlassCard style={styles.infoCard} intensity={30}>
                            ...
                            <View style={[styles.emailBadge, { backgroundColor: theme.colors.glass }]}>
                                <Text style={[styles.emailText, { color: theme.colors.text }]}>support@datingapp.com</Text>
                            </View>
                        </GlassCard>
                    </Motion.SlideUp>
