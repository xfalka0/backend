...
const MALE_NAMES_ARRAY = [
    'abdurrahman', 'abdullah', 'abdulkadir', 'abdulkerim', 'adabi', 'adem', 'adnan', 'afsin', 'affiliate', 'akin', 'ahmet', 'ali', 'alper', 'alperen', 'anil', 'arda', 'arif', 'atilla', 'aziz', 'ayhan', 'aykut', 'baris', 'batuhan', 'bayram', 'behcet', 'berat', 'berk', 'berkay', 'bekir', 'bora', 'bulent', 'burak', 'cafer', 'cagatay', 'cavit', 'celal', 'cem', 'cemal', 'cevat', 'cihan', 'cengiz', 'cumali', 'davut', 'dogan', 'dogukan', 'dundar', 'ekrem', 'emir', 'emircan', 'emrah', 'emre', 'enes', 'enver', 'eray', 'ercan', 'erdem', 'erdogan', 'eren', 'erhan', 'erol', 'ersin', 'faruk', 'fatih', 'ferhat', 'fikret', 'fuat', 'furkan', 'gencay', 'gokhan', 'gokay', 'goksel', 'gursel', 'hakan', 'halil', 'hamza', 'harun', 'hasan', 'haydar', 'hikmet', 'huseyin', 'ibrahim', 'ihsan', 'ilhan', 'isa', 'ismail', 'ismet', 'kadir', 'kaan', 'kamil', 'karadayi', 'kazim', 'kemal', 'kerem', 'kiziltas', 'koksal', 'koray', 'levent', 'lokman', 'mahmut', 'mehmet', 'mert', 'mertcan', 'mesut', 'metehan', 'metin', 'mgelvg', 'muhammed', 'muhammet', 'murat', 'mustafa', 'muzaffer', 'necati', 'necip', 'nevzat', 'nihat', 'nuri', 'nusret', 'nurullah', 'okan', 'okten', 'omer', 'onur', 'orhan', 'osman', 'ozan', 'ozgur', 'polat', 'ramadan', 'ramazan', 'rasim', 'recep', 'ridvan', 'riza', 'sabri', 'sadik', 'sahin', 'sait', 'salih', 'sami', 'samet', 'savas', 'sedat', 'sefa', 'selcuk', 'selim', 'semih', 'serdar', 'serdal', 'serhat', 'sevket', 'sinan', 'suat', 'sultan', 'suleyman', 'taha', 'tamer', 'taner', 'tarik', 'tayyip', 'tekin', 'tolga', 'tuncay', 'turan', 'ugur', 'umut', 'ummet', 'veysel', 'volkan', 'yakup', 'yalcin', 'yasin', 'yasar', 'yavuz', 'yigit', 'yilmaz', 'yunus', 'yusuf', 'zafer', 'zeki', 'izzet', 'bilal', 'faysal', 'alpaslan', 'sefer', 'celil', 'suha', 'dadas', 'abuzer', 'agah', 'akif', 'asim', 'aslan', 'atac', 'aybars', 'ayberk', 'aydemir', 'aydin', 'ayhan', 'aytekin', 'aziz', 'azmi', 'bahadir', 'bahtiyar', 'baki', 'balkan', 'bamsi', 'barbaros', 'baskin', 'baskurt', 'basri', 'battal', 'bedir', 'bedirhan', 'bedri', 'behzad', 'bera', 'berkan', 'besim', 'beyani', 'birol', 'boran', 'boyzan', 'bozkurt', 'bugra', 'bulut', 'bunyamin', 'burhan', 'burhanettin', 'cabbar', 'cahit', 'can', 'caner', 'canip', 'canpolat', 'celalettin', 'cemali', 'cemil', 'cemsit', 'cenk', 'cevahir', 'cevdet', 'cevher', 'cezmi', 'cihangir', 'civan', 'coskun', 'cuma', 'cumhur', 'cuneyt', 'daghan', 'dalay', 'danis', 'demir', 'demirhan', 'dervis', 'devran', 'devrim', 'dilaver', 'dinc', 'dinger', 'diren', 'dogu', 'dogus', 'duran', 'dursun', 'duru', 'ebu', 'ebubekir', 'ecevit', 'ediz', 'efe', 'efecan', 'efendi', 'eflatun', 'egemen', 'ege', 'ender', 'engin', 'enis', 'ensar', 'eralp', 'erbak', 'erden', 'ergin', 'ergun', 'erkin', 'erkut', 'ertan', 'ertekin', 'ertugrul', 'esat', 'esref', 'evren', 'eymen', 'eyup', 'fahrettin', 'fahri', 'faik', 'fahriddin', 'fazil', 'fehmi', 'fehim', 'ferit', 'ferdi', 'feridun', 'ferman', 'fethi', 'fevzi', 'feyyaz', 'feyzullah', 'fikri', 'galip', 'gani', 'gazi', 'gediz', 'gencer', 'giyas', 'giyasettin', 'gokalp', 'gokcan', 'gokdeniz', 'gokmen', 'gokturk', 'gorkem', 'guven', 'guney', 'guray', 'gurbuz', 'gurkan', 'hakki', 'haldun', 'halim', 'halis', 'halit', 'haluk', 'hamdi', 'hamit', 'hasbi', 'hasim', 'hatay', 'hayati', 'hayrettin', 'hayri', 'hazim', 'hazrat', 'hidayet', 'hilmi', 'himmet', 'hulusi', 'husnu', 'husrev', 'idris', 'ikbal', 'ilhami', 'ilker', 'ilter', 'ilyas', 'imdat', 'inan', 'inanc', 'kaan', 'kadri', 'kasim', 'kaya', 'kayahan', 'kemalettin', 'kenan', 'koray', 'korkut', 'koksal', 'kudret', 'kurban', 'kursat', 'kutay', 'lutfi', 'lutfullah', 'mahir', 'mahzun', 'malkoc', 'mansur', 'mazhar', 'mazin', 'mecit', 'medeni', 'melih', 'memduh', 'menderes', 'menduh', 'menter', 'merter', 'mete', 'mithat', 'muammer', 'muaz', 'muharrem', 'muhlis', 'muhsin', 'muhtar', 'muhyiddin', 'mujdat', 'mukremin', 'mumin', 'munir', 'murtaza', 'musa', 'mutlu', 'muslum', 'nabi', 'naci', 'nadir', 'nafi', 'nail', 'naim', 'namik', 'nasir', 'nasuh', 'nazif', 'nazim', 'nazmi', 'nebi', 'necdet', 'necmettin', 'necmi', 'nedim', 'nejat', 'neset', 'nezat', 'nezih', 'niyazi', 'nizam', 'nizamettin', 'nuh', 'numan', 'nurettin', 'ogun', 'oguz', 'oguzhan', 'oktay', 'okyanus', 'olcay', 'omerfaruk', 'onder', 'orhun', 'ozcan', 'ozdemir', 'ozer', 'ozhan', 'ozkan', 'paksoy', 'pala', 'pamir', 'parlan', 'pars', 'pasa', 'peyami', 'polat', 'poyraz', 'rafey', 'rafet', 'rahim', 'rahmi', 'raif', 'ramiz', 'rasit', 'rauf', 'refik', 'reha', 'remzi', 'resul', 'resat', 'resit', 'ridvan', 'rifat', 'rifki', 'ruchan', 'rustem', 'rustu', 'sadi', 'sadullah', 'safa', 'saffet', 'sahir', 'sakip', 'salim', 'samih', 'sener', 'sermet', 'sertac', 'servet', 'seyfi', 'seyfullah', 'seyit', 'sezai', 'sezer', 'sezgin', 'sitki', 'soner', 'subhi', 'suphi', 'sumer', 'sungur', 'saban', 'sadi', 'safak', 'sahin', 'sakir', 'samil', 'sanal', 'sansal', 'sayan', 'sefik', 'semsi', 'senol', 'serafettin', 'serif', 'sevki', 'sih', 'sinasi', 'sukru', 'taha', 'tahir', 'tahsin', 'talat', 'talha', 'talip', 'tanju', 'tarkan', 'tayfun', 'tayfur', 'taylan', 'tayyar', 'temel', 'teoman', 'tevfik', 'tunc', 'tuncer', 'turgay', 'turgut', 'turkay', 'turker', 'tursun', 'ufuk', 'ugur', 'ulas', 'ulvi', 'umit', 'unal', 'unalmis', 'utku', 'uysal', 'uzun', 'uzer', 'vakas', 'vahit', 'varol', 'vedat', 'vefa', 'vehbi', 'vural', 'yalcin', 'yaman', 'yekta', 'yener', 'yetkin', 'yucel', 'yuksel', 'yup', 'yusa', 'zahit', 'zekai', 'zekeriya', 'zeynel', 'zeynelabidin', 'zihni', 'ziya', 'zorlu', 'zulfu', 'zulkuf'
];
