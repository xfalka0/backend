                        ...
                        <div key={profile.id} className="group relative">
                            ...
                            <div className="relative bg-slate-900/50 backdrop-blur-xl border border-white/5 rounded-[30px] overflow-hidden group-hover:border-white/10 transition-all border-b-4 border-b-purple-500/20">
                                ...
                                <div className="p-4 flex items-center justify-between">
                                    ...
                                    <button className="p-2.5 bg-white/5 hover:bg-rose-500 text-slate-400 hover:text-white rounded-xl border border-white/5 transition-all shadow-lg active:scale-95"><Trash2 size={18} /></button>
                                </div>
                            </div>
                        </div>
                    ))}
